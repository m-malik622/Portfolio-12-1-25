          ...
          <CardContent className="space-y-2 pt-6 text-sm">
            <VerticalTimeline lineColor="rgba(168, 133, 255, 0.2)">
              <VerticalTimelineElement
                ...
                contentArrowStyle={{
                  borderRight: "7px solid rgba(254, 242, 242, 0.95)",
                }}
                date="Upcoming"
                iconStyle={{ background: "rgb(239, 68, 68)", color: "#111827" }}
                icon={<Gamepad2Icon />}
              >
                ...
                <p>
                  Currently preparing for GeauxHack 2026, a large-scale LSU
                  hackathon focused on collaboration, rapid prototyping, and
                  building creative projects in a competitive environment.
                </p>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                ...
                contentArrowStyle={{
                  borderRight: "7px solid rgba(240, 253, 250, 0.95)",
                }}
                iconStyle={{
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p>
                      <strong className="text-teal-700">Advice:</strong>{" "}
              ...
              <VerticalTimelineElement
                ...
                iconStyle={{ background: "rgb(234, 88, 12)", color: "#111827" }}
                icon={<UserRound />}
              >
                <div className="space-y-3">
                  <h3 className="vertical-timeline-element-title font-semibold">
                  ...
                  >
                    <p>
                      <strong className="text-orange-700">Role:</strong>{" "}
                    ...
                    <p>
                      <strong className="text-orange-700">Lesson:</strong>{" "}
                    ...
                    <p>
                      <strong className="text-orange-700">Advice:</strong>{" "}
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    <p>
                      <strong className="text-purple-700">Project:</strong>{" "}
                    ...
                    <p>
                      <strong className="text-purple-700">Lesson:</strong>{" "}
                    ...
                    <p>
                      <strong className="text-purple-700">Advice:</strong> When
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p>
                      <strong className="text-blue-700">Lesson:</strong> Success
                    ...
                    <p>
                      <strong className="text-blue-700">Advice:</strong> Plan
              ...
              <VerticalTimelineElement
                ...
                iconStyle={{ background: "rgb(34, 197, 94)", color: "#111827" }}
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    <p>
                      <strong className="text-emerald-700">Project:</strong> An
                    ...
                    <p>
                      <strong className="text-emerald-700">Lesson:</strong> A
                    ...
                    <p>
                      <strong className="text-emerald-700">Advice:</strong> Plan
              ...
              <VerticalTimelineElement
                ...
                iconStyle={{ background: "rgb(217, 119, 6)", color: "#111827" }}
                icon={<PlayIcon />}
              >
                <div className="space-y-3">
                  <h3 className="vertical-timeline-element-title font-semibold">
                  ...
                  >
                    <p>
                      <strong className="text-amber-700">Lesson:</strong>{" "}
                    ...
                    <p>
                      <strong className="text-amber-700">Project:</strong> A
                      simple website where you can set multiple timers. It was
                      my first webpage, so we will leave it at that!
                      ¯\_(ᵕ—ᴗ—)_/¯
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-2 pt-2">
